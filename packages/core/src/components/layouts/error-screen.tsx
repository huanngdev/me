...
export function ErrorScreen({ code, message, description, action }: ErrorScreenProps) {
  return (
    <>
      <section className="mx-auto flex min-h-[calc(100dvh-3.75rem)] max-w-4xl flex-col items-center justify-center gap-4 border-x px-4 py-16 text-center sm:px-6 lg:px-8">
